...
import uni.big_data.spark.betweenness_centrality.less_messages.BetweennessCentralityLessMessages
...
object BetweennessCentralityJob   {
  ...
  def main(arg: Array[String]): Unit = {
    ...
    val betweennessCentralityValues = BetweennessCentralityLessMessages.run(weightedGraph)
